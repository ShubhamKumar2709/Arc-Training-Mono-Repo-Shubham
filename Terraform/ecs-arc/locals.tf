  ...
  ecs_services = {
    service1 = {
      ...
      ecs_service = {
        ...
        repository_name          = "289598792045.dkr.ecr.us-east-1.amazonaws.com/arc-demo:latest"
        ecs_subnets              = data.aws_subnets.private.ids
        enable_load_balancer     = true
        aws_lb_target_group_name = "arc-poc-alb"
        create                   = true
      }
      ...
      lb_data = {
        listener_port     = 80
        security_group_id = "sg-0c002df75640ea6ab"
      }
    }
  }
